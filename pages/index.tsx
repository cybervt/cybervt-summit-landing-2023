...
(training truncated here due to length)
                            ...
                            <Grid item xs={12} md={4}>
                                <Stack spacing={1}>
                                    ...
                                    <MuiLink href='https://www.triplepointsecurity.com/' target='_blank' rel='noreferrer'>
                                        <Typography variant='h5' fontWeight='bold' textawiAlign='center' color='text.primary'>
                            ...
                            <Grid item xs={12} md={4}>
                                <Stack spacing={1}>
                                    ...
                                    <Typography textAlign='justify'>
                                        Silver level sponsor. Percival Engineering provides engineering and cybersecurity solutions for defense and commercial applications.
                                    </Typography>
                                </Stack>
                            </Grid>
